...
class PostAdapter(private var mContext: Context,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.likeButton.setOnClickListener{
            Log.d("likeTask",holder.likeButton.tag.toString())
...
//                        Log.d("likeTask","impl")
    ...
    class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        ...
        init {
            profileImage = itemView.findViewById(R.id.userProfileImageSearchPL)
            postImage = itemView.findViewById(R.id.postImageHomePL)
            likeButton = itemView.findViewById(R.id.postImageLikeButtonPL)
            commentButton = itemView.findViewById(R.id.postImageCommentButtonPL)
            saveButton = itemView.findViewById(R.id.postSaveCommentButtonPL)
            userName = itemView.findViewById(R.id.userNameSearchPL)
            likes = itemView.findViewById(R.id.likesPL)
            description = itemView.findViewById(R.id.descriptionPL)
            publisher = itemView.findViewById(R.id.publisherPL)
            comments = itemView.findViewById(R.id.commentsPL)
        }
    }
